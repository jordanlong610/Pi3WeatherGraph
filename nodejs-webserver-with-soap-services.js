...
var csvParser  = require('csv-parse'); //Needs version 1.2.2 to run  https://github.com/adaltas/node-csv-parse/releases
var fs         = require('fs');
var glob       = require("glob");

var port                   = 9998; //to listen on ports < 1024 the script must run with root privileges
